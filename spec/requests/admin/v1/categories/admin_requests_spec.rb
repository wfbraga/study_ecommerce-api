...
RSpec.describe 'Admin::V1::Categories as :admin', type: :request do
  ...
  context 'POST /categories' do
    ...
    context 'with valid params' do
      let(:category_params) { { category: attributes_for(:category) }.as_json }
  ...
  context 'PATCH /categories/:id' do
    ...
    context 'with valid params' do
      let(:new_name) { 'New Name to Category'}
      let(:category_params) { { category: { name: new_name } }.as_json }
    ...
    context 'with invalid params' do
      let(:category_invalid_params) do
        { category: attributes_for(:category, name: nil).as_json }
      end
